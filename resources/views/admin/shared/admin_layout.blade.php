            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                ...
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('yonetim.index') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                </span>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                                <div class="message-body">
                                    <a href="javascript:void(0)" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn btn-outline-primary mx-3 mt-2 d-block">Çıkış Yap</a>
                                </div>
                            </div>
                        </li>
                    </ul>
